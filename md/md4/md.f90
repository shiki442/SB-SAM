...
contains  
  ...
  subroutine cb1(defm, stress)
    ...
    open(15, file='../data4/data_params.txt')
...
SUBROUTINE INIT_NHC
 ...
 subroutine save_data
    ...
    num= num2str(mt)
    open(12, file='../data4/pos-f.dat', position='append')

    write(12, '(6E20.10)') (x(i, :), f(i, :), i = 1, nmax)

    close(12)

   !  open(12, file='../data4/pos-f'//num//'.dat')
   !  open(13, file='../data4/pos-f'//num//'.xyz')
 ...
 subroutine save_init_pos
    ...
    open(14, file='../data4/init_pos.dat')
